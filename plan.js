...
const PLAN = {
  phases: [
    ...
    },
    {
      ...
      name: "Strength & Power",
      range: [7, 14],
      blurb: "Heavier leg loading with your adjustable dumbbells, single-leg work, and the first plyometrics for real quad and glute strength.",
      days: {
        A: {
          title: "Lower Body Strength+",
          warmup: "5 min march + 10 bodyweight squats to open up",
          exercises: [
            { name: "Bulgarian split squats (rear foot elevated)", detail: "3 × 10 per leg (dumbbells at sides)" },
            { name: "Jump squats", detail: "3 × 10 (bodyweight — no weights on jumps)" },
            { name: "Curtsy lunges", detail: "3 × 10 per leg (hold dumbbells)" },
            { name: "Single-leg glute bridge", detail: "3 × 12 per leg (dumbbell on hips, optional)" },
            { name: "Wall sit with calf raise", detail: "3 × 45 sec (hug one dumbbell to chest)" },
          ],
        ...
        B: {
          ...
          exercises: [
            ...
            { name: "Single-leg deadlift (dumbbells)", detail: "3 × 10 per leg (hold dumbbells)" },
            { name: "Russian twists", detail: "3 × 20 (hold one dumbbell)" },
        ...
        C: {
          ...
          exercises: [
            ...
            { name: "Step-up with knee drive", detail: "3 × 12 per leg (hold dumbbells)" },
    ...
    },
    {
      ...
      days: {
        A: {
          ...
          exercises: [
            { name: "Athletic-stance squat hold (feet wide, slight sideways turn)", detail: "3 × 45 sec (goblet hold one dumbbell)" },
            { name: "Jump squats with soft landing (ollie pop pattern)", detail: "4 × 10 (bodyweight — no weights on jumps)" },
            { name: "Single-leg calf raises (edge-pressure control)", detail: "3 × 15 per leg (hold dumbbells)" },
            { name: "Lateral bounds, toe-to-heel emphasis", detail: "4 × 12 per side" },
            { name: "Single-leg squat (assisted, to a box or chair)", detail: "3 × 8 per leg (goblet hold, light dumbbell)" },
          ],
        ...
        B: {
          ...
          exercises: [
            ...
            { name: "Standing wood chops (twist through the core)", detail: "3 × 12 per side (hold one dumbbell)" },
